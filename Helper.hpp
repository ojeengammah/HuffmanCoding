...
public:
     ...
     *
     * @example write a char:  outFile.write<char>(dat);
     * @example write a short: outFile.write<short>(dat);
     * @example write a int:   outFile.write<int>(dat);
     *          outFile is an instance of FancyOutputStream
     *          
     * @tparam T type, can be int(4 bytes), short(2 bytes), or char(1 byte)
